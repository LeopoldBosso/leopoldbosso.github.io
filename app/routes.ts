...
route("folio", "routes/folio.tsx", [
    ...
    route("suite-aurora", "routes/project/suiteaurora.tsx"),
    route("logiciel-gidoc", "routes/project/gidoc.tsx"),
    route("suite-sfm", "routes/project/sfm.tsx"),
    route("meta-40", "routes/project/meta-40.tsx"),
    route("anciens-postes", "routes/project/oldproject.tsx"),
