...
import { Mail, Phone, MapPin, Linkedin, HomeIcon } from "lucide-react";
...
export default function CVLeopoldBossoStyled() {
  return (
    <div className="max-w-5xl mx-auto p-8 bg-gradient-to-br from-white to-blue-50 space-y-8">
      <Link to="/">
      <Button className="print:hidden bg-white text-black hover:bg-slate-200 font-medium my-8">
            <HomeIcon className="w-4 h-4 mr-2" /> Accueil
      </Button>
      </Link>
       <motion.div
